...
# nucmer --maxmatch -c 50 -l 20 -p SK1_vs_N44_nucmer SK1.genome.fa N44.genome.fa
...
# delta-filter -m -i 90 -l 100 SK1_vs_N44_nucmer.delta > SK1_vs_N44_nucmer.filter
...
# show-coords -THrd SK1_vs_N44_nucmer.filter > SK1_vs_N44_nucmer.filter.coords
...
# syri -c SK1_vs_N44_nucmer.filter.coords -d SK1_vs_N44_nucmer.filter -r SK1.genome.fa -q N44.genome.fa --nc 5 --dir SK1_vs_N44/ --prefix SK1_vs_N44_nucmer.filter. --lf SK1_vs_N44_nucmer.filter.syri.log
